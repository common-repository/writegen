...
?>
 <div class="wrg-sidebar-content wrg-related-tags-canvas wrg-select">
 ...
 <div class="wrg-input-box wrg-input-select-big">
    <select id="wrg-related-tags-widget-selector">
       ...
       <option value="wrg-related-tags-canvas" selected><?php echo esc_html__('Related Tags', 'writegen'); ?> </option>
    ...
    <div class="wrg-sidebar-input">
       ...
       <div class="wrg-input-box">
          <input type="text" class="wrg-related-tags-content" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>"></input>
       </div>
    </div>
 </div>
       ...
       <div class="wrg-row">
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-related-tags-language">
                   <?php
          ...
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-related-tags-tone">
                   <?php
       ...
       <div class="wrg-row">
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-related-tags-w-style">
                   <?php
             ...
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-quantity-box">
                   <div class="wrg-quantity-2">
                      ...
                      <input class="wrg-quantity-input-2 wrg-related-tags-number" type="text" value="10">
 ...
 <button class="wrg-btn-big wrg-related-tags-btn w-full mb-35" type="button">
 ...
 <div class="wrg-analysis-wrapper wrg-related-tags-result">
    <!-- item -->
