...
?>
 <div class="wrig-sidebar-content wrig-blog-outlines-canvas wrig-select">
 <div class="wrig-sidebar-inpur-wrapper mb-30">
    ...
    <div class="wrig-input-box wrig-input-select-big">
       <select id="wrig-blog-outlines-widget-selector">
          ...
          <option value="wrig-blog-outlines-canvas" selected><?php echo esc_html__('Blog Outlines', 'writegen'); ?></option>
    ...
    <div class="wrig-sidebar-input">
       ...
       <div class="wrig-input-box">
          <input type="text" class="wrig-blog-outlines-title" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>">
       </div>
    </div>
 </div>
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-blog-outlines-language">
                   <?php
          ...
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-blog-outlines-tone">
                   <?php
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-blog-outlines-wr-style">
             ...
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-quantity-box">
                   <div class="wrig-quantity-2">
                      ...
                      <input class="wrig-quantity-input-2 wrig-blog-outlines-length" type="text" value="10">
 ...
 <button class="wrig-btn-big wrig-blog-outlines-btn w-full mb-35" type="button">
 ...
 <div class="wrig-analysis-wrapper wrig-blog-outlines-item-show">
    <!-- item -->
