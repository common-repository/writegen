...
?>
 <div class="wrig-sidebar-content wrig-product-title-canvas wrig-select">
   <div class="wrig-sidebar-inpur-wrapper mb-30">
      ...
      <div class="wrig-input-box wrig-input-select-big">
         <select id="wrig-product-title-widget-selector">
            ...
            <option value="wrig-product-title-canvas" selected><?php echo esc_html__('Product Title', 'writegen'); ?></option>
      ...
      <div class="wrig-sidebar-input">
         ...
         <div class="wrig-input-box">
            <input type="text" class="wrig-single-product-title" placeholder="<?php echo esc_attr__('Enter Your Keyword here', 'writegen'); ?>"></input>
         </div>
      </div>
      <div class="wrig-sidebar-input">
      <div class="wrig-sidebar-input-title">
      ...
      <div class="wrig-input-box">
         <textarea class="wrig-single-product-keywords" placeholder="<?php echo esc_attr__('Enter a brief description or the keywords for this product, seperated by commas', 'writegen'); ?>"></textarea>
      </div>
   </div>
   </div>
         ...
         <div class="wrig-row">
            <div class="wrig-col-6">
               <div class="wrig-sidebar-input">
                  ...
                  <div class="wrig-input-box">
                     <select class="wrig-single-product-language">
                     <?php
            ...
            <div class="wrig-col-6">
               <div class="wrig-sidebar-input">
                  ...
                  <div class="wrig-input-box">
                     <select class="wrig-single-product-tone">
                     <?php
         ...
         <div class="wrig-row">
            <div class="wrig-col-6">
               <div class="wrig-sidebar-input">
                  ...
                  <div class="wrig-input-box">
                     <select class="wrig-single-product-writing-style">
                     <?php
               ...
               <div class="wrig-sidebar-input">
                  ...
                  <div class="wrig-quantity-box">
                     <div class="wrig-quantity-2">
                        ...
                        <input class="wrig-quantity-input-2 wrig-single-product-max-result" type="text" value="3">
   ...
   <button class="wrig-btn-big wrig-single-product-title-btn w-full mb-35" type="button">
   ...
   <div class="wrig-analysis-wrapper wrig-product-title-result">
      <!-- item -->
