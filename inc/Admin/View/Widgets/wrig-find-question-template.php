...
?>
 <div class="wrig-sidebar-content wrig-find-question-canvas wrig-select">
 <div class="wrig-sidebar-inpur-wrapper mb-30">
    <div class="wrig-sidebar-input">
       ...
       <div class="wrig-input-box wrig-input-select-big">
          <select id="wrig-find-question-widget-selector">
             ...
             <option value="wrig-find-question-canvas" selected><?php echo esc_html__('Find Question', 'writegen'); ?></option>
    ...
    <div class="wrig-sidebar-input">
       ...
       <div class="wrig-input-box">
          <input type="text" class="wrig-find-question-content" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>"></input>
       </div>
    </div>
 </div>
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-find-question-language">
                   <?php
          ...
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-find-question-tone">
                   <?php
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-find-question-w-style">
                   <?php
             ...
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-quantity-box">
                   <div class="wrig-quantity-2">
                      ...
                      <input class="wrig-quantity-input-2 wrig-find-question-number" type="text" value="10">
 ...
 <button class="wrig-btn-big wrig-find-question-btn w-full mb-35" type="button">
 ...
 <div class="wrig-analysis-wrapper wrig-find-question-result">
    <!-- item -->
