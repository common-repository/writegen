 ...
 * Includes sidebar blog product long description widget.
...
?>
<div class="wrg-sidebar-content wrg-product-long-desc-canvas wrg-select">
   ...
   <div class="wrg-input-box wrg-input-select-big">
      <select id="wrg-product-long-desc-widget-selector">
         ...
         <option value="wrg-product-long-desc-canvas" selected><?php echo esc_html__('Product Long Description', 'writegen'); ?></option>
   ...
   <div class="wrg-sidebar-input">
      <div class="wrg-sidebar-input-title">
         ...
         <div class="wrg-tooltip-wrapper">
            ...
            <div class="wrg-tooltip-content">
               <p><?php echo esc_html__('Enter the product title of product long description.', 'writegen'); ?></p>
            </div>
      </div>
      </div>
      <div class="wrg-input-box">
         <input type="text" class="wrg-single-product-long-desc-title" placeholder="<?php echo esc_html__('Enter Your Keyword here', 'writegen'); ?>"></input>
      </div>
   </div>
   <div class="wrg-sidebar-input">
   <div class="wrg-sidebar-input-title">
      ...
      <div class="wrg-tooltip-wrapper">
         ...
         <div class="wrg-tooltip-content">
            <p><?php echo esc_html__('Provide the keyword of your product.', 'writegen'); ?></p>
         </div>
   </div>
   </div>
   <div class="wrg-input-box">
      <textarea class="wrg-single-product-long-desc-keywords" placeholder="<?php echo esc_html__('Enter a brief description or the keywords for this product, seperated by commas', 'writegen'); ?>"></textarea>
   </div>
</div>
</div>
      ...
      <div class="wrg-row">
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-input-box">
                  <select class="wrg-single-product-long-desc-language">
                  <?php
         ...
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-input-box">
                  <select class="wrg-single-product-long-desc-tone">
                  <?php
      ...
      <div class="wrg-row">
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-input-box">
                  <select class="wrg-single-product-long-desc-w-style">
                  <?php
            ...
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-quantity-box">
                  <div class="wrg-quantity-2">
                     ...
                     <input class="wrg-quantity-input-2 wrg-single-product-long-desc-length" type="text" value="500">
...
<button class="wrg-btn-big wrg-single-product-long-desc-btn w-full mb-35" type="button">
