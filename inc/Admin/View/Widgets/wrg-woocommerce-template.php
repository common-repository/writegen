...
?>
  <div class="wrg-sidebar-main-content wrg-woocommerce-widget-canvas">

  <!-- tab start -->
  <div class="wizard-header wrg-wc-widzard-header">
     <div class="wrg-sidebar-tab-wrapper steps ">
        <div class="wrg-sidebar-tab-btn wrg-wc-wizard-step wrg-product-title active"><?php echo esc_html__('Title', 'writegen' ); ?></div>
        <div class="wrg-sidebar-tab-btn wrg-wc-wizard-step wrg-product-long-des"><?php echo esc_html__('Long desc', 'writegen' ); ?></div>
        <div class="wrg-sidebar-tab-btn wrg-wc-wizard-step wrg-product-short-des"><?php echo esc_html__('Short desc', 'writegen' ); ?></div>
     </div>
     <!-- tab end -->
  </div>

  <div class="wrg-sidebar-content-body wrg-wc-wizard-body">
     <!-- content start -->
     <div class="wrg-sidebar-content wrg-select step initial active">
        <div class="wrg-sidebar-inpur-wrapper mb-30">
           <div class="wrg-sidebar-input">
              ...
              <div class="wrg-input-box">
                 <input type="text" class="wrg-product-name" placeholder="<?php echo esc_attr__('Enter Your Keyword here', 'writegen' ); ?>">
              </div>
           </div>
           <div class="wrg-sidebar-input">
              <div class="wrg-sidebar-input-title">
              ...
              <div class="wrg-input-box">
                 <textarea class="wrg-product-brief" placeholder="<?php echo esc_attr__('e.g. mobile, laptop...', 'writegen' ); ?>"></textarea>
              </div>
           </div>
        </div>
              ...
              <div class="wrg-row">
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                          <select class="wrg-product-language">
                          <?php
              ...
              <div class="wrg-row">
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                          <select class="wrg-product-writing-style">
                          <?php
                    ...
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-quantity-box">
                          <div class="wrg-quantity">
                             ...
                             <input class="wrg-quantity-input wrg-product-max-result" type="text" value="2">
        ...
        <button class="wrg-btn-big wrg-product-title-generate w-full mb-35" type="button">
        ...
        <div class="wrg-analysis-wrapper wrg-product-title-item-show">
           <!-- item show -->
     ...
     <div class="wrg-sidebar-content wrg-select step">
        ...
        <div class="wrg-input-box">
           <input type="text" name="wrg_product_title" placeholder="<?php echo esc_html__('Enter Your product title here', 'writegen' ); ?>" class="wrg-product-long-title">
        </div>
     </div>
           <div class="wrg-sidebar-input">
              <div class="wrg-sidebar-input-title">
              ...
              <div class="wrg-input-box">
                 <textarea class="wrg-product-long-context" placeholder="<?php echo esc_attr__('Enter a brief description or the keywords for this product, seperated by commas', 'writegen' ); ?>"></textarea>
              </div>
           </div>
        </div>
              ...
              <div class="wrg-row">
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                          <select class="wrg-product-des-language">
                          <?php
                              foreach ($wrg_language_options as $value => $label) {
                              ?>
                              <option value="<?php echo esc_attr($value);?>"><?php echo esc_html($label); ?></option>
                 ...
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                          <select class="wrg-product-des-tone">
                          <?php
                                foreach ($wrg_tone_options as $value => $label) {
                                 ?>
                                 <option value="<?php echo esc_attr($value);?>"><?php echo esc_html($label) ?></option>
              ...
              <div class="wrg-row">
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                          <select class="wrg-product-des-w-style">
                          <?php
                                foreach ($wrg_writing_style_options as $value => $label) {
                                 ?>
                                 <option value="<?php echo esc_attr($value);?>"><?php echo esc_html($label); ?></option>
                    ...
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-quantity-box">
                          <div class="wrg-quantity-2">
                             ...
                             <input class="wrg-quantity-input-2 wrg-product-long-length" type="text" value="400">
        ...
        <button class="wrg-btn-big w-full mb-35 wrg-generate-long-des-btn" type="button">
     ...
     <div class="wrg-sidebar-content wrg-select step">
        <div class="wrg-sidebar-inpur-wrapper mb-30">
           ...
           <div class="wrg-input-box">
              <input type="text" name="wrg_product_title" placeholder="<?php echo esc_html__('Enter Your product title here', 'writegen' ); ?>" class="wrg-product-short-title">
           </div>
        </div>
           ...
           <div class="wrg-sidebar-input">
              ...
              <div class="wrg-input-box">
                 <textarea class="wrg-product-short-context" placeholder="<?php echo esc_attr__('Enter a brief description or the keywords for this product, seperated by commas', 'writegen' ); ?>"></textarea>
              </div>
           </div>
        </div>
              ...
              <div class="wrg-row">
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                          <select class="wrg-product-short-language">
                          <?php
                              foreach ($wrg_language_options as $value => $label) {
                              ?>
                              <option value="<?php echo esc_attr($value);?>"><?php echo esc_html($label); ?></option>
                 ...
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                          <select class="wrg-product-short-tone">
                          <?php
                                include(plugin_dir_path(dirname(__FILE__)) . '/Helper/wrg-writing-tone-options.php');
                                foreach ($wrg_tone_options as $value => $label) {
                                 ?>
                                 <option value="<?php echo esc_attr($value);?>"><?php echo esc_html($label) ?></option>
                                 <?php
              ...
              <div class="wrg-row">
                 <div class="wrg-col-6">
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-input-box">
                       <select class="wrg-product-short-w-style">
                           <?php
                                foreach ($wrg_writing_style_options as $value => $label) {
                                 ?>
                                 <option value="<?php echo esc_attr($value);?>"><?php echo esc_html($label); ?></option>
                    ...
                    <div class="wrg-sidebar-input">
                       ...
                       <div class="wrg-quantity-box">
                          <div class="wrg-quantity">
                             ...
                             <input class="wrg-quantity-input wrg-product-short-length" type="text" value="150">
                             <span class="wrg-quantity-plus">
                                <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                   <path d="M5 1V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                   <path d="M1 5H9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <button class="wrg-btn-big w-full mb-35 wrg-generate-short-des-btn" type="button">
