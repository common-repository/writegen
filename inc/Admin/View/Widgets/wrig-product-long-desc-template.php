...
?>
<div class="wrig-sidebar-content wrig-product-long-desc-canvas wrig-select">
   ...
   <div class="wrig-input-box wrig-input-select-big">
      <select id="wrig-product-long-desc-widget-selector">
         ...
         <option value="wrig-product-long-desc-canvas" selected><?php echo esc_html__('Product Long Description', 'writegen'); ?></option>
   ...
   <div class="wrig-sidebar-input">
      ...
      <div class="wrig-input-box">
         <input type="text" class="wrig-single-product-long-desc-title" placeholder="<?php echo esc_html__('Enter Your Keyword here', 'writegen'); ?>"></input>
      </div>
   </div>
   <div class="wrig-sidebar-input">
   <div class="wrig-sidebar-input-title">
   ...
   <div class="wrig-input-box">
      <textarea class="wrig-single-product-long-desc-keywords" placeholder="<?php echo esc_html__('Enter a brief description or the keywords for this product, seperated by commas', 'writegen'); ?>"></textarea>
   </div>
</div>
</div>
      ...
      <div class="wrig-row">
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-single-product-long-desc-language">
                  <?php
         ...
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-single-product-long-desc-tone">
                  <?php
      ...
      <div class="wrig-row">
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-single-product-long-desc-w-style">
                  <?php
            ...
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-quantity-box">
                  <div class="wrig-quantity-2">
                     ...
                     <input class="wrig-quantity-input-2 wrig-single-product-long-desc-length" type="text" value="500">
...
<button class="wrig-btn-big wrig-single-product-long-desc-btn w-full mb-35" type="button">
