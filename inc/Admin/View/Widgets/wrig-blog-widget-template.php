...
include(plugin_dir_path(dirname(__FILE__)) . '/Helper/wrig-helper.php');
  ...
  $wrig_serp_analysis = esc_attr(get_option('wrig_serp_analytics') ?? '');
  ?>
 <div class="wrig-sidebar-main-content wrig-blog-widget-canvas">
      <!-- tab start -->
      <div class="wizard-header">
         <div class="wrig-sidebar-tab-wrapper steps ">
            <div class="wrig-sidebar-tab-btn wizard-step wrig-blog-title active"><?php echo esc_html__('Title', 'writegen'); ?></div>
            <div class="wrig-sidebar-tab-btn wizard-step wrig-blog-meta-description"><?php echo esc_html__('Meta description', 'writegen'); ?></div>
            <div class="wrig-sidebar-tab-btn wizard-step wrig-blog-content"><?php echo esc_html__('Content', 'writegen'); ?></div>
         </div>
         <!-- tab end -->
      </div>
      <div class="wrig-sidebar-content-body wizard-body">
         <!-- content start -->
         <div class="wrig-sidebar-content wrig-select step initial active">
            <div class="wrig-sidebar-inpur-wrapper mb-30">
               <div class="wrig-sidebar-input">
                  ...
                  <div class="wrig-input-box">
                     <input type="text" name="wrig_search_keywords" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>" class="wrig-search-keywords">
                  </div>
               </div>
               <div class="wrig-sidebar-input">
               <div class="wrig-sidebar-input-title">
               ...
               <div class="wrig-input-box">
                  <textarea placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>" class="wrig-context"></textarea>
               </div>
            </div>
            <?php
            if( $wrig_serp_analysis == 'on'){
            ?>
               ...
               <div class="wrig-row">
                  <div class="wrig-col-6">
                     <div class="wrig-sidebar-input">
                        ...
                        <div class="wrig-input-box ">
                           <select class="wrig-select-analysis-keywords-language">
                  ...
                  <div class="wrig-quantity-box">
                     <div class="wrig-quantity">
                        ...
                        <input class="wrig-quantity-input wrig-analysis-keywords-number" type="text" value="5">
            ...
            <button class="wrig-btn-big wrig-generate-analysis-keyword w-full mb-35" type="button">
            ...
            <div class="wrig-analysis-wrapper wrig-keyword-analysis-show">
            <!-- item -->
                  ...
                  <div class="wrig-row">
                     <div class="wrig-col-6">
                        <div class="wrig-sidebar-input">
                           ...
                           <div class="wrig-input-box ">
                              <select class="wrig-select-language">
                              <?php
                  ...
                  <div class="wrig-row">
                     <div class="wrig-col-6">
                        <div class="wrig-sidebar-input">
                           ...
                           <div class="wrig-input-box">
                              <select class="wrig-select-writing-style">
                        ...
                        <div class="wrig-sidebar-input">
                           ...
                           <div class="wrig-quantity-box">
                              <div class="wrig-quantity">
                                 ...
                                 <input class="wrig-quantity-input wrig-quantity-title" type="text" value="3">
                                 <span class="wrig-quantity-plus">
                                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M5 1V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M1 5H9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <button class="wrig-btn-big wrig-generate-title w-full mb-35" type="button">
            ...
            <div class="wrig-analysis-wrapper wrig-title-item-show">
         ...
         <div class="wrig-sidebar-content wrig-select step">
            <div class="wrig-sidebar-inpur-wrapper mb-30">
               <div class="wrig-sidebar-input">
                  ...
                  <div class="wrig-input-box">
                     <input type="text" name="wrig_meta_des_title" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>" class="wrig-meta-des-title">
                  </div>
               </div>
               <div class="wrig-sidebar-input">
                  <div class="wrig-sidebar-input-title">
                  ...
                  <div class="wrig-input-box">
                     <input type="text" name="wrig_meta_des_focus_keyword" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>" class="wrig-meta-des-focus-keyword">
                  </div>
               </div>
            </div>
                        ...
                        <div class="wrig-sidebar-input">
                           ...
                           <div class="wrig-quantity-box">
                              <div class="wrig-quantity">
                                 ...
                                 <input class="wrig-quantity-input wrig-blog-metadesch-number" type="text" value="3">
                                 <span class="wrig-quantity-plus">
                                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M5 1V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M1 5H9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <button class="wrig-btn-big w-full mb-35 wrig-generate-meta-des-btn" type="button">
            ...
            <div class="wrig-analysis-wrapper wrig-meta-description-item-show">
               <!-- item -->
         ...
         <div class="wrig-sidebar-content wrig-select step">
            <div class="wrig-sidebar-inpur-wrapper mb-30">
               <div class="wrig-sidebar-input">
                  ...
                  <div class="wrig-input-box">
                     <input type="text" name="wrig_content_title" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>" class="wrig-content-title">
                  </div>
               </div>
               <div class="wrig-sidebar-input">
                  <div class="wrig-sidebar-input-title">
                  ...
                  <div class="wrig-input-box">
                     <textarea placeholder="<?php echo esc_attr__('e.g. bean coffee ...', 'writegen'); ?>" class="wrig-content-metades"></textarea>
                  </div>
               </div>
            </div>
                        ...
                        <div class="wrig-sidebar-input">
                           ...
                           <div class="wrig-quantity-box">
                              <div class="wrig-quantity">
                                 ...
                                 <input class="wrig-quantity-input wrig-words-length" type="text" value="1000">
                                 <span class="wrig-quantity-plus">
                                    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M5 1V9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M1 5H9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <button class="wrig-btn-big w-full mb-35 wrig-generate-content-btn" type="button">
