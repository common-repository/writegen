...
?>
<div class="wrig-sidebar-content wrig-blog-brief-canvas wrig-select">
 ...
 <div class="wrig-sidebar-input">
    ...
    <label><?php echo esc_html__('Select template', 'writegen'); ?></label>
       ...
       <div class="wrig-input-box wrig-input-select-big">
          <select id="wrig-blog-brief-widget-selector">
             ...
             <option value="wrig-blog-brief-canvas" selected><?php echo esc_html__('Blog Brief', 'writegen'); ?></option>
    ...
    <div class="wrig-sidebar-input">
       ...
       <div class="wrig-input-box">
          <textarea class="wrig-blog-brief-content" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>"></textarea>
       </div>
    </div>
 </div>
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-blog-brief-language">
                   <?php
          ...
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-blog-brief-tone">
                   <?php
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-blog-brief-w-style">
                   <?php
             ...
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-quantity-box">
                   <div class="wrig-quantity-2">
                      ...
                      <input class="wrig-quantity-input-2 wrig-blog-brief-quantity" type="text" value="2">
 ...
 <button class="wrig-btn-big wrig-blog-brief-btn w-full mb-35" type="button">
 ...
 <div class="wrig-analysis-wrapper wrig-blog-brief-item-show"></div>
</div>