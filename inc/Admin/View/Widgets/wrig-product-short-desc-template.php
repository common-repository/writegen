...
?>
<div class="wrig-sidebar-content wrig-product-short-desc-canvas wrig-select">
 <div class="wrig-sidebar-inpur-wrapper mb-30">
   <div class="wrig-sidebar-input">
      ...
      <div class="wrig-input-box wrig-input-select-big">
         <select id="wrig-product-short-widget-selector">
            ...
            <option value="wrig-product-short-desc-canvas" selected><?php echo esc_html__('Product Short Description', 'writegen'); ?></option>
         </select>
      </div>
   </div>
         <div class="wrig-sidebar-input">
            ...
            <div class="wrig-input-box">
               <input type="text" class="wrig-single-product-short-desc-title" placeholder="<?php echo esc_attr__('Enter Your Keyword here', 'writegen'); ?>"></input>
            </div>
         </div>
         <div class="wrig-sidebar-input">
         <div class="wrig-sidebar-input-title">
         ...
         <div class="wrig-input-box">
            <textarea class="wrig-single-product-short-desc-keywords" placeholder="<?php echo esc_attr__('Enter a brief description or the keywords for this product, seperated by commas', 'writegen'); ?>"></textarea>
         </div>
      </div>
      </div>
            ...
            <div class="wrig-row">
               <div class="wrig-col-6">
                  <div class="wrig-sidebar-input">
                     ...
                     <div class="wrig-input-box">
                        <select class="wrig-single-product-short-desc-language">
                        <?php
               ...
               <div class="wrig-col-6">
                  <div class="wrig-sidebar-input">
                     ...
                     <div class="wrig-input-box">
                        <select class="wrig-single-product-short-desc-tone">
                        <?php
            ...
            <div class="wrig-row">
               <div class="wrig-col-6">
                  <div class="wrig-sidebar-input">
                     ...
                     <div class="wrig-input-box">
                        <select class="wrig-single-product-short-desc-w-style">
                        <?php
                  ...
                  <div class="wrig-sidebar-input">
                     ...
                     <div class="wrig-quantity-box">
                        <div class="wrig-quantity-2">
                           ...
                           <input class="wrig-quantity-input-2 wrig-single-product-short-desc-length" type="text" value="200">
      ...
      <button class="wrig-btn-big wrig-single-product-short-desc-btn w-full mb-35" type="button">
