...
?>
<div class="wrig-sidebar-content wrig-blog-content-canvas wrig-select">
...
<div class="wrig-sidebar-input">
   ...
   <div class="wrig-input-box wrig-input-select-big">
      <select id="wrig-blog-content-widget-selector">
         ...
         <option value="wrig-blog-content-canvas" selected><?php echo esc_html__('Blog Content', 'writegen'); ?></option>
   ...
   <div class="wrig-sidebar-input">
      ...
      <div class="wrig-input-box">
         <input type="text" class="wrig-blog-conten-title" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>">
      </div>
   </div>
</div>
      ...
      <div class="wrig-row">
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-blog-content-language">
                  <?php
         ...
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-blog-content-tone">
                  <?php
      ...
      <div class="wrig-row">
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-blog-content-wr-style">
            ...
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-quantity-box">
                  <div class="wrig-quantity-2">
                     ...
                     <input class="wrig-quantity-input-2 wrig-blog-content-length" type="text" value="1000">
...
<button class="wrig-btn-big wrig-blog-content-btn w-full mb-35" type="button">
