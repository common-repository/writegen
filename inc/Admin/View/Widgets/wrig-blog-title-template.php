...
?>
 <div class="wrig-sidebar-content wrig-blog-title-canvas wrig-select">
 <div class="wrig-sidebar-inpur-wrapper mb-30">
    <div class="wrig-sidebar-input">
       ...
       <div class="wrig-input-box wrig-input-select-big">
          <select id="wrig-blog-title-widget-selector">
             ...
             <option value="wrig-blog-title-canvas" selected><?php echo esc_html__('Blog Title', 'writegen'); ?> </option>
    ...
    <div class="wrig-input-box">
       <textarea class="wrig-single-blog-keywords" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?> "></textarea>
    </div>
 </div>
 </div>
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-single-blog-language">
                   <?php
          ...
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-single-blog-tone">
                   <?php
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-single-blog-writing-style">
                   <?php
             ...
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-quantity-box">
                   <div class="wrig-quantity-2">
                      ...
                      <input class="wrig-quantity-input-2 wrig-single-blog-max-result" type="text" value="3">
 ...
 <button class="wrig-btn-big wrig-single-blog-title-btn w-full mb-35" type="button">
 ...
 <div class="wrig-analysis-wrapper wrig-blog-title-result">
    <!-- item -->
