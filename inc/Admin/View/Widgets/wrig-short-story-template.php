...
?>
<div class="wrig-sidebar-content wrig-short-story-canvas wrig-select">
...
<div class="wrig-input-box wrig-input-select-big">
   <select id="wrig-short-story-widget-selector">
      ...
      <option value="wrig-short-story-canvas" selected><?php echo esc_html__('Short Story', 'writegen'); ?></option>
   ...
   <div class="wrig-sidebar-input">
      ...
      <div class="wrig-input-box">
         <input type="text" class="wrig-short-story-content" placeholder="<?php echo esc_attr__('e.g. A Mysterious Island, A Journey of Discovery...', 'writegen'); ?>"></input>
      </div>
   </div>
</div>
      ...
      <div class="wrig-row">
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-short-story-language">
                  <?php
         ...
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-short-story-tone">
                  <?php
      ...
      <div class="wrig-row">
         <div class="wrig-col-6">
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-input-box">
                  <select class="wrig-short-story-w-style">
                  <?php
            ...
            <div class="wrig-sidebar-input">
               ...
               <div class="wrig-quantity-box">
                  <div class="wrig-quantity-2">
                     ...
                     <input class="wrig-quantity-input-2 wrig-short-story-length" type="text" value="200">
...
<button class="wrig-btn-big wrig-short-story-btn w-full mb-35" type="button">
...
<div class="wrig-analysis-wrapper wrig-short-story-result">
   <!-- item -->
