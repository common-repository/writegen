 ...
 * Includes sidebar blog outlines widget.
...
?>
 <div class="wrg-sidebar-content wrg-blog-outlines-canvas wrg-select">
 <div class="wrg-sidebar-inpur-wrapper mb-30">
    ...
    <div class="wrg-input-box wrg-input-select-big">
       <select id="wrg-blog-outlines-widget-selector">
          ...
          <option value="wrg-blog-outlines-canvas" selected><?php echo esc_html__('Blog Outlines', 'writegen'); ?></option>
    ...
    <div class="wrg-sidebar-input">
       <div class="wrg-sidebar-input-title">
          <label><?php echo esc_html__('Blog Title', 'writegen'); ?></label>
          <div class="wrg-tooltip-wrapper">
             <span>
                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                   <path d="M7.5 13.5C11.0899 13.5 14 10.5899 14 7C14 3.41015 11.0899 0.5 7.5 0.5C3.91015 0.5 1 3.41015 1 7C1 10.5899 3.91015 13.5 7.5 13.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
             ...
             <div class="wrg-tooltip-content">
                <p><?php echo esc_html__('Enter the title or topic of your blog post.', 'writegen'); ?></p>
             </div>
       </div>
       </div>
       <div class="wrg-input-box">
          <input type="text" class="wrg-blog-outlines-title" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>">
       </div>
    </div>
 </div>
       ...
       <div class="wrg-row">
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-blog-outlines-language">
                   <?php
          ...
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-blog-outlines-tone">
                   <?php
       ...
       <div class="wrg-row">
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-blog-outlines-wr-style">
                   <select class="wrg-writegen-writingstyle">
                   <?php
          ...
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                <div class="wrg-sidebar-input-title">
                   <label><?php echo esc_html__('Max Result', 'writegen'); ?></label>
                   <div class="wrg-tooltip-wrapper">
                      <span>
                         <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.5 13.5C11.0899 13.5 14 10.5899 14 7C14 3.41015 11.0899 0.5 7.5 0.5C3.91015 0.5 1 3.41015 1 7C1 10.5899 3.91015 13.5 7.5 13.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"/>
                      ...
                      <div class="wrg-tooltip-content">
                         <p><?php echo esc_html__('Maximum outlines you want to generate.', 'writegen'); ?></p>
                      </div>
                </div>
                </div>
                <div class="wrg-quantity-box">
                   <div class="wrg-quantity-2">
                      ...
                      <input class="wrg-quantity-input-2 wrg-blog-outlines-length" type="text" value="10">
 ...
 <button class="wrg-btn-big wrg-blog-outlines-btn w-full mb-35" type="button">
 ...
 <div class="wrg-analysis-wrapper wrg-blog-outlines-item-show">
    <!-- item -->
