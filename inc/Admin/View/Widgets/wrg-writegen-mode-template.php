...
?>
<div class="wrg-sidebar-content wrg-writegen-mode-canvas wrg-select">
...
<div class="wrg-input-box wrg-input-select-big">
   <select id="wrg-writegen-mode-widget-selector">
      ...
      <option value="wrg-writegen-mode-canvas" selected><?php echo esc_html__('WriteGen mode', 'writegen'); ?> </option>
   ...
   <div class="wrg-sidebar-input">
      ...
      <div class="wrg-input-box">
         <textarea class="wrg-writegen-content" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?> "></textarea>
      </div>
   </div>
</div>
            ...
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-quantity-box">
                  <div class="wrg-quantity-2">
                     ...
                     <input class="wrg-quantity-input-2 wrg-writegen-quantity" type="text" value="2">
...
<button class="wrg-btn-big wrg-writegen-mode-btn w-full mb-35" type="button">
