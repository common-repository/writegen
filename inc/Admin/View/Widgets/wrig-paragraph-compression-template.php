...
?>
<div class="wrig-sidebar-content wrig-paragraph-compression-canvas wrig-select">
<div class="wrig-sidebar-inpur-wrapper mb-30">
  ...
  <div class="wrig-input-box wrig-input-select-big">
     <select id="wrig-paragraph-compression-widget-selector">
        ...
        <option value="wrig-paragraph-compression-canvas" selected><?php echo esc_html__('Paragraph Compression', 'writegen'); ?></option>
     ...
     <div class="wrig-sidebar-input">
        ...
        <div class="wrig-input-box">
           <textarea class="wrig-paragraph-compression-content" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>"></textarea>
        </div>
     </div>
  </div>
        ...
        <div class="wrig-row">
           <div class="wrig-col-6">
              <div class="wrig-sidebar-input">
                 ...
                 <div class="wrig-input-box">
                    <select class="wrig-paragraph-compression-language">
                    <?php
           ...
           <div class="wrig-col-6">
              <div class="wrig-sidebar-input">
                 ...
                 <div class="wrig-input-box">
                    <select class="wrig-paragraph-compression-tone">
                    <?php
        ...
        <div class="wrig-row">
           <div class="wrig-col-6">
              <div class="wrig-sidebar-input">
                 ...
                 <div class="wrig-input-box">
                    <select class="wrig-paragraph-compression-w-style">
                    <?php
              ...
              <div class="wrig-sidebar-input">
                 ...
                 <div class="wrig-quantity-box">
                    <div class="wrig-quantity-2">
                       ...
                       <input class="wrig-quantity-input-2 wrig-paragraph-compression-ratio" type="text" value="1">
  ...
  <button class="wrig-btn-big wrig-paragraph-compression-btn w-full mb-35" type="button">
  ...
  <div class="wrig-analysis-wrapper wrig-paragraph-compression-result">
     <!-- item -->
