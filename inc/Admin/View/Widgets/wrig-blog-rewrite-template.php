...
?>
<div class="wrig-sidebar-content wrig-blogrewrite-canvas wrig-select">
 <div class="wrig-sidebar-inpur-wrapper mb-30">
    <div class="wrig-sidebar-input">
       ...
       <div class="wrig-input-box wrig-input-select-big">
          <select id="wrig-blog-rewrite-widget-selector">
             ...
             <option value="wrig-blogrewrite-canvas" selected><?php echo esc_html__('Blog Rewrite', 'writegen'); ?></option>
    ...
    <div class="wrig-sidebar-input">
       ...
       <div class="wrig-input-box">
          <textarea class="wrig-blogrewrite-content" placeholder="<?php echo esc_html__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>"></textarea>
       </div>
    </div>
 </div>
    ...
    <div class="wrig-row">
       <div class="wrig-col-6">
          <div class="wrig-sidebar-input">
             ...
             <div class="wrig-input-box">
                <select class="wrig-blogrewrite-language">
                     <?php
       ...
       <div class="wrig-col-6">
          <div class="wrig-sidebar-input">
             ...
             <div class="wrig-input-box">
                <select class="wrig-blogrewrite-tone">
                <?php
       ...
       <div class="wrig-row">
          <div class="wrig-col-6">
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-input-box">
                   <select class="wrig-blogrewrite-writing-style">
                   <?php
             ...
             <div class="wrig-sidebar-input">
                ...
                <div class="wrig-quantity-box">
                   <div class="wrig-quantity-2">
                      ...
                      <input class="wrig-quantity-input-2 wrig-writegen-quantity" type="text" value="500">
 ...
 <button class="wrig-btn-big wrig-blogrewrite-btn w-full mb-35" type="button">
