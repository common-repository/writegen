 ...
 * Includes sidebar blog rewrite widget.
...
?>
<div class="wrg-sidebar-content wrg-blogrewrite-canvas wrg-select">
 <div class="wrg-sidebar-inpur-wrapper mb-30">
    <div class="wrg-sidebar-input">
       ...
       <div class="wrg-input-box wrg-input-select-big">
          <select id="wrg-blog-rewrite-widget-selector">
             ...
             <option value="wrg-blogrewrite-canvas" selected><?php echo esc_html__('Blog Rewrite', 'writegen'); ?></option>
    ...
    <div class="wrg-sidebar-input">
       ...
       <div class="wrg-input-box">
          <textarea class="wrg-blogrewrite-content" placeholder="<?php echo esc_html__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>"></textarea>
       </div>
    </div>
 </div>
    ...
    <div class="wrg-row">
       <div class="wrg-col-6">
          <div class="wrg-sidebar-input">
             ...
             <div class="wrg-input-box">
                <select class="wrg-blogrewrite-language">
                     <?php
       ...
       <div class="wrg-col-6">
          <div class="wrg-sidebar-input">
             ...
             <div class="wrg-input-box">
                <select class="wrg-blogrewrite-tone">
                <?php
       ...
       <div class="wrg-row">
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-blogrewrite-writing-style">
                   <?php
             ...
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-quantity-box">
                   <div class="wrg-quantity-2">
                      ...
                      <input class="wrg-quantity-input-2 wrg-writegen-quantity" type="text" value="500">
 ...
 <button class="wrg-btn-big wrg-blogrewrite-btn w-full mb-35" type="button">
 ...
 <div class="wrg-analysis-wrapper wrg-writegen-item-show">
    <!-- item -->
 </div>
</div>