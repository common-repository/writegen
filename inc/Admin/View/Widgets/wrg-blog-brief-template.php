 ...
 * Includes sidebar blog brief widget.
...
?>
<div class="wrg-sidebar-content wrg-blog-brief-canvas wrg-select">
 ...
 <div class="wrg-sidebar-input">
    ...
    <label><?php echo esc_html__('Select template', 'writegen'); ?></label>
       ...
       <div class="wrg-input-box wrg-input-select-big">
          <select id="wrg-blog-brief-widget-selector">
             ...
             <option value="wrg-blog-brief-canvas" selected><?php echo esc_html__('Blog Brief', 'writegen'); ?></option>
    ...
    <div class="wrg-sidebar-input">
       <div class="wrg-sidebar-input-title">
          ...
          <div class="wrg-tooltip-wrapper">
             ...
             <div class="wrg-tooltip-content">
                <p><?php echo esc_html__('Provide the context of your blog brief.', 'writegen'); ?></p>
             </div>
       </div>
       </div>
       <div class="wrg-input-box">
          <textarea class="wrg-blog-brief-content" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>"></textarea>
       </div>
    </div>
 </div>
       ...
       <div class="wrg-row">
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-blog-brief-language">
                   <?php
          ...
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-blog-brief-tone">
                   <?php
       ...
       <div class="wrg-row">
          <div class="wrg-col-6">
             <div class="wrg-sidebar-input">
                ...
                <div class="wrg-input-box">
                   <select class="wrg-blog-brief-w-style">
                   <?php
             ...
             <div class="wrg-sidebar-input">
                <div class="wrg-sidebar-input-title">
                   ...
                   <div class="wrg-tooltip-wrapper">
                      ...
                      <div class="wrg-tooltip-content">
                         <p><?php echo esc_html__('Maximum brief you want to generate.', 'writegen'); ?></p>
                      </div>
                </div>
                </div>
                <div class="wrg-quantity-box">
                   <div class="wrg-quantity-2">
                      ...
                      <input class="wrg-quantity-input-2 wrg-blog-brief-quantity" type="text" value="2">
 ...
 <button class="wrg-btn-big wrg-blog-brief-btn w-full mb-35" type="button">
 ...
 <div class="wrg-analysis-wrapper wrg-blog-brief-item-show"></div>
</div>