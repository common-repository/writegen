 ...
 * Includes sidebar blog tags widget.
...
?>
<div class="wrg-sidebar-content wrg-blog-tags-canvas wrg-select">
<div class="wrg-sidebar-inpur-wrapper mb-30">
   <div class="wrg-sidebar-input">
      ...
      <div class="wrg-input-box wrg-input-select-big">
         <select id="wrg-blog-tags-widget-selector">
            ...
            <option value="wrg-blog-tags-canvas" selected><?php echo esc_html__('Blog Tags', 'writegen'); ?></option>
   ...
   <div class="wrg-sidebar-input">
      ...
      <div class="wrg-input-box">
         <input type="text" class="wrg-blog-tags-title" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>">
      </div>
   </div>
</div>
      ...
      <div class="wrg-row">
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-input-box">
                  <select class="wrg-blog-tags-language">
                  <?php
         ...
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-input-box">
                  <select class="wrg-blog-tags-tone">
                  <?php
      ...
      <div class="wrg-row">
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-blog-tags-wr-style">
            ...
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-quantity-box">
                  <div class="wrg-quantity-2">
                     ...
                     <input class="wrg-quantity-input-2 wrg-blog-tags-length" type="text" value="10">
...
<button class="wrg-btn-big wrg-blog-tags-btn w-full mb-35" type="button">
...
<div class="wrg-analysis-wrapper wrg-blog-tags-result">
<!-- item -->
