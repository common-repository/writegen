 ...
 * Includes sidebar blog content widget.
...
?>
<div class="wrg-sidebar-content wrg-blog-content-canvas wrg-select">
...
<div class="wrg-sidebar-input">
   ...
   <div class="wrg-input-box wrg-input-select-big">
      <select id="wrg-blog-content-widget-selector">
         ...
         <option value="wrg-blog-content-canvas" selected><?php echo esc_html__('Blog Content', 'writegen'); ?></option>
   ...
   <div class="wrg-sidebar-input">
      ...
      <div class="wrg-input-box">
         <input type="text" class="wrg-blog-conten-title" placeholder="<?php echo esc_attr__('e.g. bean coffee, best coffee mak...', 'writegen'); ?>">
      </div>
   </div>
</div>
      ...
      <div class="wrg-row">
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-input-box">
                  <select class="wrg-blog-content-language">
                  <?php
         ...
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-input-box">
                  <select class="wrg-blog-content-tone">
                  <?php
      ...
      <div class="wrg-row">
         <div class="wrg-col-6">
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-blog-content-wr-style">
            ...
            <div class="wrg-sidebar-input">
               ...
               <div class="wrg-quantity-box">
                  <div class="wrg-quantity-2">
                     ...
                     <input class="wrg-quantity-input-2 wrg-blog-content-length" type="text" value="1000">
...
<button class="wrg-btn-big wrg-blog-content-btn w-full mb-35" type="button">
